...
| [`no-expensive-animation-properties`](https://nick2bad4u.github.io/stylelint-plugin-css-performance-budget/docs/rules/no-expensive-animation-properties) | — | [🟢](./docs/rules/configs/performance-budget-recommended.md) [🛡️](./docs/rules/configs/performance-budget-strict.md) [🟣](./docs/rules/configs/performance-budget-all.md) | Warn on expensive animation and transition targets, including `transition: all` and costly keyframe properties. |
...
| [`no-layout-thrashing-properties`](https://nick2bad4u.github.io/stylelint-plugin-css-performance-budget/docs/rules/no-layout-thrashing-properties) | — | [🟢](./docs/rules/configs/performance-budget-recommended.md) [🛡️](./docs/rules/configs/performance-budget-strict.md) [🟣](./docs/rules/configs/performance-budget-all.md) | Warn on declarations that commonly trigger layout/reflow work in the rendering pipeline. |
...
| [`no-paint-heavy-declarations`](https://nick2bad4u.github.io/stylelint-plugin-css-performance-budget/docs/rules/no-paint-heavy-declarations) | — | [🟢](./docs/rules/configs/performance-budget-recommended.md) [🛡️](./docs/rules/configs/performance-budget-strict.md) [🟣](./docs/rules/configs/performance-budget-all.md) | Warn on declaration properties that are typically expensive for paint/compositing. |
